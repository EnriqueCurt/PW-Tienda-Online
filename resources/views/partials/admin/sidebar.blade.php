<flux:sidebar sticky stashable class="bg-zinc-900 border-r border-zinc-800">
    ...
    <flux:navlist variant="outline">
        ...
        <flux:navlist.item href="#" icon="clipboard-document-list" wire:navigate>Pedidos</flux:navlist.item>
        <flux:navlist.item href="#" icon="users" wire:navigate>Usuarios</flux:navlist.item>
    </flux:navlist>

    <flux:spacer />

    <flux:navlist variant="outline">
        <flux:navlist.item href="#" icon="cog-6-tooth" wire:navigate>Configuración</flux:navlist.item>
